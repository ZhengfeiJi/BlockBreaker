...
public class Block {
    ...
    /**
     * Getter, used to return the starting health of a block
     *
    ...
    /**
     * Getter, return transition type. When a Block is hit, this tells the block which color to change to. Different number means different color changes.
