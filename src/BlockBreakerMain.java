...
/**
 * This class launches the actual game and defines the main game mechanics
 * <p> * 
 * The class was derived from an example for LWJGL, which was modified and built upon. Here is the link  <a href="https://www.lwjgl.org/guide">https://www.lwjgl.org/guide</a>.
 * This class opens a window that supports drawing objects via OpenGL. This is the class that acutally calls all the methods for drawing visuals.
 * It stores most of the games inner constants and variables as fields. Here you can change all most all of the games behaviour by changing the values of fields
 **/
...
public class BlockBreakerMain {
    ...
    private final float wallXSoftness = 0.92f;  // Zero is maximum softness.
    private final float padSideSoftness = 0.8f;
    private final float blockSideSoftness = 0.92f;

    private final float padHeight = 0.02f;
    ...
    private final float ballRadius = 0.008f;
    ...
    private final float centreBlockY = 0.45f;  // Height of the central block
    
    private float blockWidth = 0.27f;
    private float blockHeight = 0.135f;
    
    private final int blockHealthGreen = 1;
    private final int blockHealthBlue = 2;
    private final int blockHealthRed = 3;   
    private final int blockHealthCentral = 6;
    ...
    /**
     * Gets the horizontal velocity of the mouse movement
     *
    ...
    /**
     * Method to add balls with time interval between appearances.
     *
     * 
     * @param pads Used to get the horizontal position of the pad so the balls came be added at the same position. 
     */
    ...
    /**
     * Sets the balls to be drawn to zero and resets the ball adding counters         
     */    
    ...
    /**
     * Fills the window with block starting from the centre. Next it fill the central row expanding horizontally from centre and the add more rows in the vertical direction in the same way, starting from the centre.         
     */  
    ...
    /**
     * Retrieves the number of lives left.
     *
     ...
     *
     * @param Number of lives as integer
     */
     ...
     *
     * @param Number of balls as integer
     */
